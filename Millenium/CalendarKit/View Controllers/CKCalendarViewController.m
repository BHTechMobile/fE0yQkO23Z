...
- (void)calendarView:(CKCalendarView *)calendarView willSelectDate:(NSDate *)date withAnimated:(BOOL)animated
{
    ...
    if ([[self delegate] respondsToSelector:@selector(calendarView:willSelectDate:withAnimated:)]) {
        [[self delegate] calendarView:calendarView willSelectDate:date withAnimated:animated];
    }
}
...
- (void)calendarView:(CKCalendarView *)calendarView didSelectDate:(NSDate *)date withAnimated:(BOOL)animated
{
    ...
    if ([[self delegate] respondsToSelector:@selector(calendarView:didSelectDate:withAnimated:)]) {
        [[self delegate] calendarView:calendarView didSelectDate:date withAnimated:animated];
    }
}
...
- (void)calendarView:(CKCalendarView *)calendarView frameCalendarView:(CGRect)frame{
    ...
    if ([[self delegate] respondsToSelector:@selector(calendarView:frameCalendarView:)]) {
        [[self delegate] calendarView:calendarView frameCalendarView:frame];
    }
}
